 ...
 * {@link CalendarUser} using the Spring Security's {@link Authentication} by
 * principal name.
 * 
 * @author Rob Winch
 * 
...
public class SpringSecurityUserContext implements UserContext {
   ...
   * Security user's {@link Authentication#getName()} and using that to find the
   * {@link CalendarUser} by email address (since for our application Spring
   * Security usernames are email addresses).
   */
  @Override
